...
def plot_results(pca_df):
    ...
    plt.suptitle('Breast Cancer Subtype Clustering: Ground Truth vs. Spectral', fontsize=16, y=1.02)
    
    plt.tight_layout()
    plt.savefig('breast_cancer_spectral_results.png')
    print("Saved 'breast_cancer_spectral_results.png'.")
