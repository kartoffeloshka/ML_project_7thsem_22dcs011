...
def plot_results(pca_df):
    ...
    plt.suptitle('Brain Tumor Subtype Clustering: Ground Truth vs. Spectral', fontsize=16, y=1.02)
    
    plt.tight_layout()
    plt.savefig('brain_cancer_spectral_results.png')
    print("Saved 'brain_cancer_spectral_results.png'.")
